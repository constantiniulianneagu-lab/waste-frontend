// src/TMBContractModal.jsx
/**
 * ============================================================================
 * TMB CONTRACT MODAL
 * ============================================================================
 * Form pentru adăugare/editare contracte operatori TMB
 * Simplu: tarif + cantitate (ca Sorting)
 * ============================================================================
 */
...
const TMBContractModal = ({ 
    ...
    try {
      ...
      if (contract) {
        response = await apiPut(
          `/api/institutions/${institutionId}/tmb-contracts/${contract.id}`,
          payload
        );
      } else {
        response = await apiPost(
          `/api/institutions/${institutionId}/tmb-contracts`,
          payload
        );
      }
  ...
  return (
    <>
      ...
      {/* Modal */}
      <div className="fixed top-0 right-0 h-full w-full sm:w-[600px] bg-white dark:bg-gray-800 shadow-2xl z-[110] overflow-y-auto">
        
        {/* Header */}
        <div className="sticky top-0 bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 p-6 flex items-center justify-between z-10">
          <h3 className="text-lg font-bold text-gray-900 dark:text-white">
            {contract ? 'Editează Contract TMB' : 'Contract Nou TMB'}
          </h3>
          <button
            onClick={onClose}
        ...
        <div className="p-6 space-y-4">
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div>
              ...
              <input
                ...
                onChange={handleInputChange}
                className="w-full px-4 py-2.5 bg-gray-50 dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-lg focus:ring-2 focus:ring-cyan-500 outline-none text-gray-900 dark:text-white"
              />
            </div>
          </div>
          ...
          <div>
            ...
            <textarea
              ...
              onChange={handleInputChange}
              rows={3}
              className="w-full px-4 py-2.5 bg-gray-50 dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-lg focus:ring-2 focus:ring-cyan-500 outline-none text-gray-900 dark:text-white resize-none"
        ...
        <div className="sticky bottom-0 bg-white dark:bg-gray-800 border-t border-gray-200 dark:border-gray-700 p-6 flex gap-3">
          ...
          <button
            onClick={handleSave}
            disabled={saving}
            className="flex-1 px-4 py-2.5 bg-gradient-to-r from-cyan-600 to-cyan-700 hover:from-cyan-700 hover:to-cyan-800 text-white font-medium rounded-lg transition-all shadow-sm hover:shadow-md disabled:opacity-50 flex items-center justify-center gap-2"
          >
            {saving ? (
              <>
...
export default TMBContractModal;