    ...
    return (
      <div className="flex h-[600px] flex-col rounded-[28px]
        ...
        <div className="flex flex-1 flex-col gap-2">
          {[1, 2, 3, 4, 5].map((i) => (
            <div key={i} className="h-20 animate-pulse rounded-[20px] bg-gray-100 dark:bg-gray-700/30"
    ...
    <div className="flex h-[600px] flex-col rounded-[28px]
      ...
      <div className="flex flex-1 flex-col gap-2 overflow-y-auto overflow-x-hidden
        ...
        {data.map((operator, idx) => {
          ...
          return (
            <div key={operator.institution_id || idx} className="group relative">
                    ...
                    {sectors.slice(0, 3).map((sectorNum, i) => {
                      ...
                      return (
                        <div key={i}
                          ...
                          <span className="text-xs font-bold text-white">{sectorNum}</span>
                        </div>
                      );
                    })}
                    {sectors.length > 3 && (
