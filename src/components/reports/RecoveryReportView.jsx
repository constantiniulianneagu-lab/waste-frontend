          ...
          <table className="w-full">
            <thead>
              <tr className="bg-gray-50 dark:bg-gray-900 border-b border-gray-200 dark:border-gray-700">
                <th className="px-4 py-3 text-left text-xs font-medium text-gray-700 dark:text-gray-300 uppercase">Tichet</th>
                <th className="px-4 py-3 text-left text-xs font-medium text-gray-700 dark:text-gray-300 uppercase">Data</th>
                <th className="px-4 py-3 text-left text-xs font-medium text-gray-700 dark:text-gray-300 uppercase">Client</th>
                ...
                <th className="px-4 py-3 text-right text-xs font-medium text-gray-700 dark:text-purple-400 uppercase">Cant. Livrată</th>
                <th className="px-4 py-3 text-right text-xs font-medium text-gray-700 dark:text-indigo-400 uppercase">Cant. Acceptată</th>
                      ...
                      <tr className="bg-gray-50 dark:bg-gray-800/30">
                        <td colSpan="9" className="px-4 py-4">
                          <div className="grid grid-cols-3 gap-4 text-sm mb-4">
                            ...
                            <div><span className="text-purple-600 dark:text-purple-400 block mb-1">Livrată:</span><p className="font-bold text-purple-700 dark:text-purple-400">{formatNumberRO(ticket.delivered_quantity_tons)} t</p></div>
                            <div><span className="text-indigo-600 dark:text-indigo-400 block mb-1">Acceptată:</span><p className="font-bold text-indigo-700 dark:text-indigo-400">{formatNumberRO(ticket.accepted_quantity_tons)} t</p></div>
