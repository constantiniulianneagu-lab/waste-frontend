                      ...
                      <tr className="bg-gray-50 dark:bg-gray-800/30">
                        <td colSpan="9" className="px-4 py-4">
                          <div className="grid grid-cols-3 gap-4 text-sm mb-4">
                            ...
                            <div><span className="text-red-600 dark:text-red-400 block mb-1">Livrată:</span><p className="font-bold text-red-700 dark:text-red-400 text-lg">{formatNumberRO(ticket.delivered_quantity_tons)} t</p></div>
                            <div><span className="text-rose-600 dark:text-rose-400 block mb-1">Acceptată:</span><p className="font-bold text-rose-700 dark:text-rose-400 text-lg">{formatNumberRO(ticket.accepted_quantity_tons)} t</p></div>
