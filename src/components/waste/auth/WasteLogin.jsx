// src/components/waste/auth/WasteLogin.jsx
...
const WasteLogin = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (data.success) {
        // Salvează tokens
        localStorage.setItem('wasteAccessToken', data.data.accessToken);
        localStorage.setItem('wasteRefreshToken', data.data.refreshToken);
        localStorage.setItem('wasteUser', JSON.stringify(data.data.user));
        
        // Redirect la dashboard
        alert('Login successful! User: ' + data.data.user.email);
